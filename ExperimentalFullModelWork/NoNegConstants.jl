...
#The above restrictions on ka7, kb1, and ka1 are in place to prevent negative rate constants
const minka7 = kcat7exp / Km7exp
function findMaxkb1(ka1;Km1exp=Km1exp)
    return Km1exp * ka1
end
...
const u0combos = makeCombos(Lrange, Krange, Prange, Arange)
const numU0combos = length(u0combos[:,1])
