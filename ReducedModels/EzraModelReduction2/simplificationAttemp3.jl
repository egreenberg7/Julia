...
fastMM!(rateEquations, dAK, AK, :dAK)
#simplifyAll!()

#Still working for row 100, no oscillations for row 30
fastMM!(rateEquations, dAP, AP, :dAP)
#compareModels(30)

#Row 100 continues to succeed
fastMM!(rateEquations, dAKL, AKL, :dAKL)
#compareModels(100)
...
#fastMM!(rateEquations, dLpAKL, LpAKL, :dLpAKL)
#compareModels(100)

#Still workin good after LpP
fastMM!(rateEquations, dLpP, LpP, :dLpP)
# compareModels(100)
